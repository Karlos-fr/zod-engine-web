...
/**
 * Adaptation of upstream `GWPFUS_MARGIN`.
...
/**
 * Adaptation of upstream `GWPFUS_TOPH`.
...
/**
 * Adaptation of upstream `GWPFUS_SIDE_SIZE`.
...
/**
 * Adaptation of upstream `GWPFUS_OBJW`.
...
/**
 * Adaptation of upstream `GWPFUS_OBJH`.
