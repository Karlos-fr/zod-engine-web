...
|---|---|---|---|
| 2026-07-26 | architecture | Séparer simulation et rendu | La simulation doit pouvoir être testée sans navigateur ni canvas. |
| 2026-07-26 | rendering | Remplacer SDL/OpenGL par Three.js | Décision supersédée le 2026-07-29 par Canvas2D pour la priorité 2D court terme. |
...
| 2026-07-29 | rendering | Cibler Canvas2D pour le rendu court terme | Le projet reste 2D dans l'immédiat; les méthodes SDL/OpenGL sont adaptées vers une API Canvas2D ou remplacées par des helpers de surfaces typés plutôt que portées vers Three.js. |
